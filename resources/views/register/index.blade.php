    ...
    <div class="col-lg-6">
        <main class="form-registration">
            <div class="d-flex justify-content-center">
                <img class="mb-3" src="eaghost.png" alt="" width="140">
            </div>
            <h1 class="h3 mb-3 fw-normal">Form Pendataran</h1>     
            ...
            <small class="mt-3">Sudah Punya Akun? <a href="/login">Login Sekarang</a></small>
        </main>
    </div>
</div>
@endsection